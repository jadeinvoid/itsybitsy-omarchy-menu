...
Item {
  ...
  readonly property var selectionPalette: [
    "#D32F37",
    "#C4A000",
    "#EB7500",
    "#469829",
  ...
  property color selectionAccent: selectionPalette[0]
  ...
  function randomizeSelectionAccent() {
    selectionAccent = selectionPalette[Math.floor(Math.random() * selectionPalette.length)]
  }

  onSelectedIndexChanged: if (cursorActive) randomizeSelectionAccent()
  onCursorActiveChanged: if (cursorActive) randomizeSelectionAccent()
  onOpenedChanged: {
    if (opened) randomizeSelectionAccent()
  ...
  property color selectedBackground: Util.alpha(selectionAccent, 0.14)
          ...
          ListView {
            ...
            delegate: BorderSurface {
              ...
              Text {
                ...
                text: row.icon
                color: row.hasCursor ? root.selectionAccent : root.foreground
